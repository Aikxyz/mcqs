...
(function() {
    ...
    const goods = [946,991,1701,1703,1705,1707,1709,1711,1713,1715,1789]
    const Goods = []
    let size = []
    let arr
    let x=0
...
*/
    ...
    ar3zpzxh0.addEventListener("message", ({ data }) => {
        ...
        if (data.startsWith('34038555')) {//
            bs[13] = 38555
        }
        if (data.startsWith('34072705')) {//
            bs[13] = 72705
        }
...
/*    // 创建开宝石箱
    ...
    autoCK.onclick = function() {
        if (ck) {
            ...
            autoCK.textContent = '自动仓';
            // const goods = [946,1701,1703,1705,1707,1709,1711,1713,1715,1789]
